...
class CompletionProjectionCoordinator:
    ...
    async def _apply_projection(
        ...
        *,
        ...
        if self._task_provider is not None and projection.task_id:
            await self._task_provider.persist_completion_projection(
                TaskScope(
