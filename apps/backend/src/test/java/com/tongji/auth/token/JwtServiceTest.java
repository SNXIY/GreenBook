...
class JwtServiceTest {
    ...
    void issueTokenPairAndDecode() {
        ...
        assertThat(tokenPair.sessionId()).isNotBlank();
        ...
        assertThat(jwtService.extractSessionId(accessJwt)).isEqualTo(tokenPair.sessionId());
        ...
        assertThat(jwtService.extractSessionId(refreshJwt)).isEqualTo(tokenPair.sessionId());
