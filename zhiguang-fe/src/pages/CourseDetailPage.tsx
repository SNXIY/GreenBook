      ...
      <article className={styles.detailCard}>
          ...
          <div ref={rowRef} className={styles.imageRow}>
            {(detail.images.slice(0, visibleCount)).map((src, idx) => {
              ...
              return (
                ...
                >
                  <img className={styles.image} src={src} alt={detail.title} width="540" height="720" loading="lazy" />
                  {isLastVisible ? (
        ...
        <div className={styles.titleBlock}>
          ...
          <div className={styles.meta}>
            {detail?.authorAvatar ? (
              <img className={styles.authorAvatar} src={detail.authorAvatar} alt={detail.authorNickname} width="36" height="36" />
            ) : null}
        ...
        {detail && id ? (
          <CommentSection postId={id} authorId={detail.authorId} />
        ) : null}

        {previewOpen && detail?.images?.length ? (
          <div className={styles.previewOverlay} role="dialog" aria-modal="true" aria-label="内容图片预览">
            <div
            ...
            >
              <img className={styles.previewImage} src={detail.images[previewIndex]} alt={detail.title} width="1200" height="900" />
              <button
                type="button"
