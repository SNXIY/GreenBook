      ...
      <form className={styles.pageCard} onSubmit={onSubmit}>
        ...
        <div className={styles.grid}>
          <div className={styles.avatarPanel}>
            ...
            {uploading ? <span className={styles.inlineStatus} role="status">上传中…</span> : null}
          </div>
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={`${styles.field} ${styles.fullWidth}`}>
              ...
              <textarea id="bio" name="bio" className={styles.textarea} value={bio} onChange={e => setBio(e.target.value)} placeholder="介绍一下自己…" autoComplete="off" />
            </div>
          </div>
        </div>
