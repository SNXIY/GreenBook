...
from .models import ExecutionControlState, ExecutionStatus
...
class RuntimeGuard:
    ...
    def can_execute(self, execution_id: str) -> bool:
        ...
        return (
            ...
            and execution.control_state == ExecutionControlState.RUNNING
        )
    ...
    def check_execution(self, execution_id: str) -> None:
        ...
        if (
            execution.status != ExecutionStatus.RUNNING
            or execution.control_state != ExecutionControlState.RUNNING
        ):
