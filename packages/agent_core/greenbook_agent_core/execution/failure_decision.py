...
class FailureClassifier:
    ...
    @classmethod
    def category_for_code(cls, code: str) -> FailureCategory:
        """Expose the canonical code classification to Agent observations."""

        normalized = str(code or "UNKNOWN_ERROR").strip().upper()
        return cls._category_for(normalized)
