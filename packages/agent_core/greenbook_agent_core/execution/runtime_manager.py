...
class RuntimeManager:
    ...
    def pause_execution(
        ...
        *,
        ...
        return self._state.pause_execution(execution_id, reason=reason)

    def resume_execution(self, execution_id: str) -> PlanExecution:
        # A human resume does not retry a failed step. It only reopens a
        # checkpointed PAUSED execution; Worker confirms RESUMING on claim.
    ...
    def cancel_execution(
        ...
        *,
        ...
        return self._state.cancel_execution(execution_id, reason=reason)
