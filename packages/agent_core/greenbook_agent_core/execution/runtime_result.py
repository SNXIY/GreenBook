...
class RuntimeResult:
    ...
    # Public Activity projection input. Each item is a completed actual tool
    # attempt (including its verified OperationReceipt when applicable), not
    # a Plan/Step presentation object.
