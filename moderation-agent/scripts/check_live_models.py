...
provider documentation) -- it is NOT part of the pytest suite, since it makes real
...
# Providers that only need an API key/flag to smoke test. Ollama and the
# OpenAI-compatible slot need local infrastructure or bespoke configuration, so
# they are not a fit for this generic sweep.
