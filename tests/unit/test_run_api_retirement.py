...
from greenbook_assistant_api.api.routes import router as assistant_router
from greenbook_assistant_api.api.runtime_routes import router as runtime_router
...
def test_legacy_runs_keeps_history_lookup_only() -> None:
    assert _route_methods("/api/v1/assistant/runs/{run_id}") == {"GET"}


def test_legacy_run_operations_are_retired() -> None:
    for path in (
        "/api/v1/assistant/runs/{run_id}/cancel",
        "/api/v1/assistant/runs/{run_id}/interrupt",
        "/api/v1/assistant/runs/{run_id}/resume",
        "/api/v1/assistant/runs/{run_id}/approve",
        "/api/v1/assistant/runs/{run_id}/events",
        "/api/v1/assistant/runs/{run_id}/events/stream",
    ):
...
def test_runtime_operations_are_canonical() -> None:
    ...
    assert _route_methods("/api/v1/assistant/executions/{execution_id}/approve") == {"POST"}
